...
eval(l2cpc);
 ...
 %cpath=['load c:\ocean2006\\\par' d 's'];  % for zigzag pattern
...
s2=['load c:\ocean2006\turbulence\\Gcmeteo2006' num2str(d) sprintf('20Hz.mat')];
eval(s2);


thetav2=interp1q(GPSTime,thetav,cmig(:,2));
thetav3=interp1q(cmig(:,1),thetav2,data2(:,1));
...
hold on
if z==1,
    plot(thetav3(j1:j2),alt(j1:j2),'.' )
else if z==2,
         plot(thetav3(j1:j2),alt(j1:j2),'.g' )
    else if z==3,
             plot(thetav3(j1:j2),alt(j1:j2),'.c' )
        else if z==4,
                plot(thetav3(j1:j2),alt(j1:j2),'.k' )
            else if z==5
                     plot(thetav3(j1:j2),alt(j1:j2),'.r' )
                else  plot(thetav3(j1:j2),alt(j1:j2),'.m' )
                end
            end
        end
    end
...
hold on
if z==1,
    semilogx(data2(j1:j2,30),alt(j1:j2),'.' )
else if z==2,
         semilogx(data2(j1:j2,30),alt(j1:j2),'.g' )
    else if z==3,
             semilogx(data2(j1:j2,30),alt(j1:j2),'.c' )
        else if z==4,
                semilogx(data2(j1:j2,30),alt(j1:j2),'.k' )
            else if z==5
                     semilogx(data2(j1:j2,30),alt(j1:j2),'.r' )
                else  semilogx(data2(j1:j2,30),alt(j1:j2),'.m' )
                end
            end
        end
    end
...
ppp=['print -djpeg profilesz060' num2str(days(i))];
%eval(ppp)
figure
